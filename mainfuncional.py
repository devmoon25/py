...
def extract_vehicle_data(driver, placa, nit):
    ...
    try:
        ...
        tipo_documento = Select(driver.find_element(By.XPATH, "//select[@formcontrolname='tipoDocumento']"))
        tipo_documento.select_by_visible_text("NIT")

        # Ingresar NIT
        nit_input = driver.find_element(By.XPATH, "//input[@formcontrolname='numeroDocumento']")
        nit_input.clear()
        ...
        captcha_input = driver.find_element(By.XPATH, "//input[@formcontrolname='captcha']")
        captcha_input.clear()
